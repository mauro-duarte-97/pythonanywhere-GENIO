    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_perfil', models.ImageField(blank=True, default=None, null=True, upload_to='perfiles/')),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('tipo_usuario', models.CharField(blank=True, choices=[('Alumno', 'Alumno'), ('Institución', 'Institución')], default='Alumno', max_length=20, null=True)),
