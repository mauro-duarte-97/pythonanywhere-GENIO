...
from google.g_validated import GoogleLoginApi, GoogleAccessTokens



GOOGLE_OAUTH2_CLIENT_ID = env.str("DJANGO_GOOGLE_OAUTH2_CLIENT_ID", default="1009220251212-nkro9apnh8d27brjpu37sq8v7lhr6cig.apps.googleusercontent.com")
GOOGLE_OAUTH2_CLIENT_SECRET = env.str("DJANGO_GOOGLE_OAUTH2_CLIENT_SECRET", default="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")
GOOGLE_OAUTH2_PROJECT_ID = env.str("DJANGO_GOOGLE_OAUTH2_PROJECT_ID", default="proyecto-integrador-ifts18")
